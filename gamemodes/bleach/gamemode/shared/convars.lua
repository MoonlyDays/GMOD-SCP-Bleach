...
br_time_squad_enter_delay_min = CreateConVar("br_time_ntf_enter_delay_min", "90", { FCVAR_SERVER_CAN_EXECUTE, FCVAR_NOTIFY }, "Minimum time that NTF units will enter the facility")
br_time_squad_enter_delay_max = CreateConVar("br_time_ntf_enter_delay_max", "180", { FCVAR_SERVER_CAN_EXECUTE, FCVAR_NOTIFY }, "Maximum time that NTF units will enter the facility")
