...
function SoundsOnRoundStart()
	surface.PlaySound("breach/alarm2.ogg")
end

function StartOutisdeSounds()
	surface.PlaySound("breach/music/Satiate Strings.ogg")
end

function StartEndSound()
	surface.PlaySound("breach/music/Mandeville.ogg")
end