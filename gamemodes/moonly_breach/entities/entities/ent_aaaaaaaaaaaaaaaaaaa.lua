...
function ENT:Initialize()
	...
	if SERVER then if roundstats ~= nil then roundstats.secretf = true end end
end
...
function ENT:OnTakeDamage(damage)
	...
	if not damage:GetAttacker():IsPlayer() then return end
	net.Start("ForcePlaySound")
	net.WriteString("breach/096_2.ogg")
